...
func (s eventStream) Publish(ctx context.Context, topicName string, event ddd.Event) error {
	...
	data, err := proto.Marshal(&EventMessageData{
		Payload:    payload,
		OccurredAt: timestamppb.New(event.Timestamp()),
		Metadata:   metadata,
	})
	if err != nil {
		return err
...
func (e eventMessage) Data() ddd.EventData {
	return e.payload
}
func (e eventMessage) Timestamp() time.Time {
	return e.occurredAt
}
func (e eventMessage) Metadata() ddd.Metadata {
	return e.metadata
}
func (e eventMessage) Version() int64 {
	return e.version
}
